...
import { UserRound, Building, MessageSquare, GraduationCap, Search, Users, TrendingUp, AlertTriangle, Heart, Globe, Award, Target, Shield } from "lucide-react";
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="mb-8 border-orange-200">
              ...
              <CardContent>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  of medical personnel and facilitating connections with reputable humanitarian 
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <Card className="border-orange-200">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Every healthcare professional in our registry provides their credentials 
                    and experience to facilitate connections with humanitarian organizations.
                  </p>
                </CardContent>
              </Card>
